...
class App extends Component {
  ...
  componentDidMount() {
    this.timerId = setInterval(() => this.updateElapsedTime, 1000)
    console.log('Hii')
  }
  ...
  getElapsedTime = () => {
    ...
    const timeRemaining = 60 - timeElapsedInSec
    return timeRemaining
  }

  render() {
    const {matchImageUrl, activeTabId, score, timeElapsedInSec} = this.state
